...
void OptionDlg::SetParams(void)
{
	...
	//new added
	_ColCmbTdsLeadin.setColor(_pProp->colorProp.rgbLeadIn);
	_ColCmbTdsMetadata.setColor(_pProp->colorProp.rgbMetaData);
	_ColCmbTdsRawdata.setColor(_pProp->colorProp.rgbRawData);
}	
...
BOOL OptionDlg::GetParams(void)
{
	...
	if (bRet == TRUE) {
		...
		//new added
		_ColCmbTdsLeadin.getColor(&_pProp->colorProp.rgbLeadIn);
		_ColCmbTdsMetadata.getColor(&_pProp->colorProp.rgbMetaData);
		_ColCmbTdsRawdata.getColor(&_pProp->colorProp.rgbRawData);
	}
	else
	{
