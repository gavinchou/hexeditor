...
//new added 
const TCHAR rgbLeadIn[]		=_T("RGB Lead In");
const TCHAR rgbMetaData[]	=_T("RGB Meta Data");
const TCHAR rgbRawData[]	=_T("RGB Raw Data");
...
typedef enum eColorType
{
	...
	//new added
	HEX_COLOR_LEADIN,//add three new colors for leadin, metadata and raw data.
	HEX_COLOR_METADATA,
	HEX_COLOR_RAWDATA
} eColorType;
...
typedef enum eSelType
{
	...
	HEX_COLOR_DIFF,
	//new added
	HEX_COLOR_TDS_LEADIN,
	HEX_COLOR_TDS_METADATA,
	HEX_COLOR_TDS_RAWDATA
} eSelType;
...
typedef struct tColor
{
	...
	//new add here.
	COLORREF            rgbLeadIn;              //Lead In color
	COLORREF            rgbMetaData;			//Meta data color
	COLORREF            rgbRawData;				//raw data color
